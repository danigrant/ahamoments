    ...
    return (
      <div>
        <form className="add-explanation-form">
          ...
          <input onChange={this.sendMediaLinkChangeToParent} className="margin-top-sml font-med background-grey rounded-border light-border" type="text" placeholder="https://soundcloud.com/ ..." name="podcast-input" />
