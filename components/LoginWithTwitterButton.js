const LogInWithTwitterButton = props => {
  return (
    <div className="button rounded-border all-caps font-sml font-bold-med twitter-color center">
      <div className="twitter-logo twitter-color margin-right-tny inline-block">
