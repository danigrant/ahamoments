...
function (_App) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_11__["default"])(AhaMoments, [{
              ...
              case 7:
                ...
                _utils_firebase__WEBPACK_IMPORTED_MODULE_19__["firebase"].auth().onAuthStateChanged(function (user) {
                  if (user) {
                    ...
                    thisRef.handleUserLoggedIn(this.user.displayName, this.user.email, this.user.photoURL, this.user.uid);
                  } else {
                    // user logged out
                    thisRef.setState({
                      loggedIn: false,
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_8___default.a.mark(function _callee2(displayName, email, photoURL, uid) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 8;
                return Object(_utils_firebase__WEBPACK_IMPORTED_MODULE_19__["saveUserToDB"])(displayName, email, photoURL, uid);
      ...
      function handleUserLoggedIn(_x, _x2, _x3, _x4) {
...
//# sourceMappingURL=_app.js.08500e0027bb3f70121c.hot-update.js.map