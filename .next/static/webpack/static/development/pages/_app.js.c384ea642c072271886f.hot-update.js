            ...
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                _utils_firebase__WEBPACK_IMPORTED_MODULE_19__["firebase"].auth().onAuthStateChanged(function (user) {
                  if (user) {
                    // User is signed in.
                    Object(_utils_firebase__WEBPACK_IMPORTED_MODULE_19__["saveUserToDB"])(user.displayName, user.email, user.photoURL, user.uid); // update state to add current user
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 8;
                return Object(_utils_firebase__WEBPACK_IMPORTED_MODULE_19__["saveUserToDB"])(user.displayName, user.email, user.photoURL, user.uid);
...
//# sourceMappingURL=_app.js.c384ea642c072271886f.hot-update.js.map