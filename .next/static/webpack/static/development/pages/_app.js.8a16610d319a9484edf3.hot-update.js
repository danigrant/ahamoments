      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            cleanText = text.replace('<script>', '').replace('onclick', '').replace('onerror').replace('onResize', '').replace('onPropertyChange', '').replace('onMouseEnter', '').replace('onFocus', ''); // then save explanation to firestore
            // first to do that, need some user profile data
...
//# sourceMappingURL=_app.js.8a16610d319a9484edf3.hot-update.js.map