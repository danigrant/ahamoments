      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            twitterStatus = tweetUrl.split('status/')[1].split('?')[0]; // let res = await fetch(`https://twitter-get-embed-code-proxy.herokuapp.com/twitter-embed-code?name=kylesamani&status=1148350276983824385`)

            _context.next = 4;
            return fetch("https://twitter-get-embed-code-proxy.herokuapp.com/get-twitter-embed-proxy?name=".concat(twitterUser, "&status=").concat(twitterStatus));
...
//# sourceMappingURL=index.js.485d97432f0ed22beb9b.hot-update.js.map