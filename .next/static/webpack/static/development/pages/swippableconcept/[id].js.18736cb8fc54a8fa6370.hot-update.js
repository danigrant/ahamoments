...
function (_React$Component) {
  ...
  function SwipableCardContainer(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "handleGoToNextCardAtContainerLevel", function () {
      _this.setState({
    ...
    value: function render() {
      ...
      if (this.state.displayCardIndex == this.state.explanationCardDeck.length) {
        ...
        return __jsx("div", {
          ...
          handleGoToNextCardAtContainerLevel: this.handleGoToNextCardAtContainerLevel,
          show: true,
          ...
          onClick: this.handleGoToNextCardAtContainerLevel,
          className: "button",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 42
...
//# sourceMappingURL=[id].js.18736cb8fc54a8fa6370.hot-update.js.map