...
function (_React$Component) {
  ...
  function SwipableCardContainer(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "handleSwipe", function () {
      _this.setState({
    ...
    value: function render() {
      if (this.state.displayCardIndex == this.state.explanationCardDeck.length) {
        ...
        return __jsx(_Card__WEBPACK_IMPORTED_MODULE_10__["default"], {
          ...
          __self: this
        }, "this.state.explanationCardDeck.length: ".concat(this.state.explanationCardDeck.length)), __jsx("p", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 42
          },
          __self: this
        }, "this.state.displayCardIndex: ".concat(this.state.displayCardIndex)), __jsx("p", {
          ...
          __self: this
        }, _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(this.state.explanationCardDeck[this.state.displayCardIndex])));
      }
    }
  }]);
...
//# sourceMappingURL=[id].js.9127dc87f9d71c8cd72e.hot-update.js.map