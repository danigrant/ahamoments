  ...
  function AddExplanationCard(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "handleSubmit", function (e) {
      ...
      if (_this.state.type == "photo" || _this.state.type == "video" || _this.state.type == "audio") {
        Object(_utils_firebase__WEBPACK_IMPORTED_MODULE_20__["saveExplanationWithFileToDB"])(_this.state.introText, _this.state.fileToUpload, _this.state.activeElement, _this.props.loggedInUser.userID, router.query.id);
        ...
        Object(_utils_firebase__WEBPACK_IMPORTED_MODULE_20__["saveExternalLinkExplanationToDB"])(_this.state.introText, _this.state.mediaLink, _this.state.mediaConsumptionGuidance, _this.state.activeElement, _this.props.loggedInUser.userID, router.query.id);
      } // reset the ui
...
//# sourceMappingURL=[id].js.714a2ad5d7175329b008.hot-update.js.map