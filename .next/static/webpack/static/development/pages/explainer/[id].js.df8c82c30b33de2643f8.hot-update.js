          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.t0 = this;
                _context.next = 3;
                return getUserByID(this.props.router.query.id);
      ...
      var router = this.props.router;
      {
        if (!this.state.currentProfileUser.displayName) {
          ...
          return __jsx("div", {
            ...
            __self: this
          }, "Here are all the different ways ", this.state.currentProfileUser.displayName, " has explained things"), __jsx("p", {
...
//# sourceMappingURL=[id].js.df8c82c30b33de2643f8.hot-update.js.map